...
<?php
    $sql="SELECT * FROM cart join product on cart.pid=product.pid WHERE user_id=".$_SESSION['userid'];
    ...
    if(mysqli_num_rows($result)>0){
        while($row=mysqli_fetch_assoc($result)){
            ...
            echo "<a href='removecart.php?id=".$row['pid']."' class='btn btn-danger m-1'>Remove</a>";
